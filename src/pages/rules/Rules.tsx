            ...
            <section>
                <div>
                    ...
                    <div className={styles.rulesNav}>
                        <PillButton text={lesson1Title} darkmode={true}/>
                        <PillButton text={lesson2Title} darkmode={true}/>
                        <PillButton text={lesson3Title} darkmode={true}/>
                        <PillButton text={lesson4Title} darkmode={true}/>
                        <PillButton text={lesson5Title} darkmode={true}/>
                        <PillButton text={lesson6Title} darkmode={true}/>
                        <PillButton text={lesson7Title} darkmode={true}/>
                    </div>
                </div>
            </section>
            <section>
